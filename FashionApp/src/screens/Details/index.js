...
import { View, Text, Dimensions, Image, TouchableOpacity, ScrollView, FlatList } from 'react-native'
...
export default function Details({ navigation }) {
    ...
    const rightContent = () => {
        return (
            <TouchableOpacity style={styles.cart_container} onPress={()=>navigation.navigate('Cart')}>
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.options_container}>
                    <TouchableOpacity style={[styles.options, { borderRightWidth: 0.25, borderRightColor: Colors.border }]}>
                        <Text style={styles.text_options}>Color</Text>
                        {Icons.Icons({ name: 'arrow_down', height: 8.7, width: 10 })}
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.options, { borderLeftWidth: 0.25, borderLeftColor: Colors.border }]}>
            ...
            <View style={styles.info_container}>
                ...
                <View style={[styles.line, { width: width - 16, marginBottom: 0, marginTop: 0 }]} />
                <TouchableOpacity style={styles.info_item}>
            ...
            <Text style={[styles.text_title, { marginTop: 15 }]}>YOU MAY ALSO LIKE</Text>
